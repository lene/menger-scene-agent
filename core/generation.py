...
_RULES = (
    ...
    "mirroring and all. This offset only holds with no rotation (`rotation = Vec3.Zero`, the "
    "default) -- a rotated object reintroduces sign-mixing relative to world axes.\n"
