...
_RULES = (
    ...
    "- You cannot see the render window. Anything the user did there -- moving the camera, "
    "rotating in 4D, zooming -- is invisible to you and is NOT in the scene file. If asked "
    "about the window's current state, say plainly that you cannot see it, then describe "
    "only what the scene file sets. Never contradict what the user reports about the window.\n"
    "- The scene file was written by this agent, not the user: never say \"you added\" or "
    "\"your change\" about its content.\n"
